...
const opcoesDaUnidade = [
  {
    ...
    route: "/(matematica)/(equacoes)/teoriaEquacoes",
    locked: false,
  },
  {
    title: "Sugestão de Vídeoaulas",
    route: "/(matematica)/(equacoes)/videoAulasEquacoes",
    locked: false,
  },
  {
    title: "Exercícios",
    route: "/(matematica)/(equacoes)/quizEquacoes",
    locked: false,
  },
  {
    title: "Simulados",
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.textHeader}>
          <View>
            <ThemedText style={styles.headerTitle}>Equações do 2º grau</ThemedText>
