...
import initialQuestions from "./questoesGrandezas.json";
      ...
      <View style={styles.startScreen}>
        ...
        <View style={styles.startTextContainer}>
          ...
          <Text style={styles.startTitle}>
            ...
            <Text style={styles.differentText}>Grandezas proporcionais e Regra de três?</Text>
          </Text>
    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.scoreScrollViewContent}>
        ...
        <View style={styles.scoreButtonContainer}>
          ...
          <BotaoCustomizado
            onPress={() =>
              router.replace("/(matematica)/(geometria)/geometria")
            }
