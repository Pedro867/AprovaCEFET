...
import { unidadesEletricidade } from "@/constants/dadosUnidades"
import AsyncStorage from "@react-native-async-storage/async-storage";

export default function telaUnidadesBio() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.matematica}><Text>Física - Eletricidade</Text></View>
      ...
      >
        ...
        <View style={styles.unitsListContainer}>
          {unidadesEletricidade.map((unidade, index) => {
