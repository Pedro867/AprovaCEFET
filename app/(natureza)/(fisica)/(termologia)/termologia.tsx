...
import { unidadesTermologia } from "@/constants/dadosUnidades"
...
export default function telaUnidadesBio() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.matematica}><Text>Física - Termologia</Text></View>
      ...
      >
        ...
        <View style={styles.unitsListContainer}>
          {unidadesTermologia.map((unidade, index) => {
